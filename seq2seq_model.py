...
# We would like to attempt different optimizers and sample sizes so those arguments will be described in the initialization function
...
class Seq2SeqModel(object):
  ...
  def __init__(self, source_vocab_size, target_vocab_size, buckets, size,
               ...
               learning_rate_decay_factor, optimizer, use_lstm=True,
               num_samples=512, forward_only=False):
    """Create the model.

    Arg:
      optimizer: the type of optimizer to use (support for Adadelta, RMSProp, Adam, SGD)
    ...
    # Create the internal multi-layer cell for our RNN. We retain support for using GRU cells instead of LSTM cells
    ...
    # Gradients for training the model.
